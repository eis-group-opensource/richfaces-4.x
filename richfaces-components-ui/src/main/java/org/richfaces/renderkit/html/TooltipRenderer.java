...
public class TooltipRenderer extends DivPanelRenderer implements MetaComponentRenderer {
    ...
    protected void doEncodeBegin(ResponseWriter writer, FacesContext context, UIComponent component) throws IOException {
        AbstractTooltip tooltip = (AbstractTooltip) component;
        escapeValue(tooltip); //escaping html tags
    ...
    /**
     * Method takes tooltip value atrribute and escapes html tags.
     *
     * @param tooltip tooltip to edit
     */
    protected void escapeValue(AbstractTooltip tooltip) {
        Object value = tooltip.getValue();
        if (tooltip.getChildCount() == 0 && value != null) {
            tooltip.setValue(StringEscapeUtils.escapeHtml4(value.toString()));
        }
    }

    protected void clearCachedValue(AbstractTooltip tooltip) {
        tooltip.setValue(null);
    }
}
