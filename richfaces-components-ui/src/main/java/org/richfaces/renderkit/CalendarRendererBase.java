...
public class CalendarRendererBase extends InputRendererBase implements MetaComponentRenderer {
    ...
    public Object getSelectedDate(FacesContext facesContext, UIComponent component) throws IOException {
        ...
        if (calendar.isValid()) {
            ...
            if (date != null) {
                returnValue = formatSelectedDate(CalendarHelper.getTimeZoneOrDefault(calendar), date, calendar);
            }
        }
        return returnValue;
    }
    ...
    public static Object formatSelectedDate(TimeZone timeZone, Date date) {
        return formatSelectedDate(timeZone, date, null);
    }

    public static Object formatSelectedDate(TimeZone timeZone, Date date, AbstractCalendar calendarInstance) {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        if( calendarInstance == null ) {
            calendarInstance = (AbstractCalendar) AbstractCalendar.getCurrentComponent(facesContext);
        }
    ...
    public static Object formatDate(Date date, AbstractCalendar calendarInstance) {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        if( calendarInstance == null ) {
            calendarInstance = (AbstractCalendar) AbstractCalendar.getCurrentComponent(facesContext);
        }
