    ...
    $.extend(richfaces.ui.PopupPanel.prototype, (function (options) {
        ...
        return {
            ...
            preventFocus:    function() {
                if (this.options.modal && !this.isOverlayPanel()) {
            ...
            isOverlayPanel: function() {
                var overlayIds = richfaces.ui.PopupPanel.overlayPanelIds;
                if(overlayIds === undefined) {
                    return false;
                }
                for(var i = 0; i < overlayIds.length; i++) {
                    if(this.id == overlayIds[i]) {
                        return true;
                    }
                }
                return false;
