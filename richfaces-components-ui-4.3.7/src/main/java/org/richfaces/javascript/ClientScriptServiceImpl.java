...
import com.google.common.cache.richfaces.MapMaker;
...
public class ClientScriptServiceImpl implements ClientScriptService {
    ...
    public ClientScriptServiceImpl(Map<Class<?>, LibraryFunction> defaultMapping) {
        ...
        resourcesMapping = (ConcurrentMap<Class<?>, LibraryFunction>) new MapMaker().initialCapacity(10).makeComputingMap(RESOURCE_SCRIPT_FUNCTION);
        annotationsMapping = (ConcurrentMap<Class<?>, LibraryFunction>) new MapMaker().initialCapacity(10).makeComputingMap(ANNOTATION_SCRIPT_FUNCTION);
    }
