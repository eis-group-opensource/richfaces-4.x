...
import static com.google.common.cache.richfaces.CollectPreconditions.checkRemove;
...
import com.google.common.cache.richfaces.MapMaker.Dummy;
...
/**
 * The concurrent hash map implementation built by {@link com.google.common.cache.richfaces.MapMaker}.
 *
...
class MapMakerInternalMap<
   ...
   */
  private MapMakerInternalMap(com.google.common.cache.richfaces.MapMaker builder, InternalEntryHelper<K, V, E, S> entryHelper) {
    ...
    for (int i = 0; i < this.segments.length; ++i) {
      this.segments[i] = createSegment(segmentSize, com.google.common.cache.richfaces.MapMaker.UNSET_INT);
    }
  }
  ...
  static <K, V> MapMakerInternalMap<K, V, ? extends InternalEntry<K, V, ?>, ?> create(
      com.google.common.cache.richfaces.MapMaker builder) {
  ...
  abstract static class AbstractSerializationProxy<K, V> extends ForwardingConcurrentMap<K, V>
    ...
    com.google.common.cache.richfaces.MapMaker readMapMaker(ObjectInputStream in) throws IOException {
      int size = in.readInt();
      return new com.google.common.cache.richfaces.MapMaker()
